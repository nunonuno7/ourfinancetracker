...
urlpatterns = [
    ...
    path(
        "transactions/totals-v2/", transactions_totals_v2, name="transactions_totals_v2"
    ),
    path(
        "transactions/export-excel/",
        export_transactions_xlsx,
        name="transaction_export_xlsx",
    ),
    path("data/export-excel/", export_data_xlsx, name="data_export_xlsx"),
    path(
        "transactions/import-excel/",
        import_transactions_xlsx,
        name="transaction_import_xlsx",
    ),
    path(
        "transactions/import/template/",
        import_transactions_template,
        name="import_transactions_template_xlsx",
    ),
    path("tasks/status/<str:task_id>/", task_status, name="task_status"),
    path(
        "transactions/clear-cache/",
        transaction_clear_cache,
        name="transaction_clear_cache",
    ),
    path(
        "transactions/clear-session-flag/",
        clear_session_flag,
        name="clear_session_flag",
    ),
    # Bulk operations
    path(
        "transactions/bulk-update/",
        transaction_bulk_update,
        name="transaction_bulk_update",
    ),
    path(
        "transactions/bulk-duplicate/",
        transaction_bulk_duplicate,
        name="transaction_bulk_duplicate",
    ),
    path(
    ...
    path(
        "transactions/estimate/manage/",
        estimate_transaction_page,
        name="estimate_transaction",
    ),
    path("transactions/estimate/", transaction_estimate, name="transaction_estimate"),
    path(
        "transactions/estimate/period/",
        estimate_transaction_for_period,
        name="estimate_transaction_for_period",
    ),
    path(
        "transactions/estimate/summaries/",
        get_estimation_summaries,
        name="get_estimation_summaries",
    ),
    path(
        "transactions/estimate/years/", get_available_years, name="get_available_years"
    ),
    path(
        "transactions/estimate/<int:transaction_id>/delete/",
        delete_estimated_transaction,
        name="delete_estimated_transaction",
    ),
    path(
        "transactions/estimate/period/<int:period_id>/delete/",
        delete_estimated_transaction_by_period,
        name="delete_estimated_transaction_by_period",
    ),
    ...
    path(
        "categories/autocomplete/", category_autocomplete, name="category_autocomplete"
    ),
    # Tags
    ...
    path(
        "accounts/<int:source_pk>/merge/<int:target_pk>/",
        AccountMergeView.as_view(),
        name="account_merge",
    ),
    ...
    path(
        "account-balance/delete/<int:pk>/",
        delete_account_balance,
        name="delete_account_balance",
    ),
    path(
        "account-balance/copy/",
        copy_previous_balances_view,
        name="copy_previous_balances",
    ),
    path(
        "account-balance/export-excel/",
        account_balance_export_xlsx,
        name="account_balance_export_xlsx",
    ),
    path(
        "account-balance/import-excel/",
        account_balance_import_xlsx,
        name="account_balance_import_xlsx",
    ),
    path(
        "account-balance/template/",
        account_balance_template_xlsx,
        name="account_balance_template_xlsx",
    ),
    # API endpoints
    ...
    path(
        "api/jwt/my-transactions/",
        api_jwt_my_transactions,
        name="api_jwt_my_transactions",
    ),
    ...
    path("dashboard/goals/", dashboard_goals_json, name="dashboard_goals_json"),
    path(
        "dashboard/insights/", dashboard_insights_json, name="dashboard_insights_json"
    ),
    path(
        "dashboard/spending-by-category/",
        dashboard_spending_by_category_json,
        name="dashboard_spending_by_category_json",
    ),
    path("dashboard/returns/", dashboard_returns_json, name="dashboard_returns_json"),
    path(
        "financial-analysis/json/",
        financial_analysis_json,
        name="financial_analysis_json",
    ),
    path("kpi/goals/", views.kpi_goals_get, name="kpi_goals_get"),
    path("kpi/goals/update/", views.kpi_goals_update, name="kpi_goals_update"),
    path(
        "api/sync-adjustments/", sync_system_adjustments, name="sync_system_adjustments"
    ),
    path(
        "account-balances/json/",
        account_balances_pivot_json,
        name="account_balances_json",
    ),
    path(
        "account-balances/pivot-json/",
        account_balances_pivot_json,
        name="account_balances_pivot_json",
    ),
    # Clear cache
